...
<h5>Edit Course: <?php echo e($data->title); ?></h5>
<form action="/editCourse<?php echo e($data->id); ?>" method="post" id="addCourseForm">
    ...
    <div id="add_module">
        ...
        <div class="card shadow-sm border-2 p-3 mb-5 bg-white rounded" id="module-<?php echo e($cm->id); ?>">
            <div class="row">
                <div class="row">
                    <div class="col-8">
                        <h3>Add Modal<?php echo e($cm->id); ?></h3>
        ...
        <script>
            function handleSelectChange(cmId) {
                const selectElement = document.getElementById(`mySelect`);
                const testSection = document.getElementById(`testSection${cmId}`);
...
<?php echo $__env->make("masterLayout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\firstProject\resources\views/editCourse.blade.php ENDPATH**/ ?>